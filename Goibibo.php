...
class Goibibo{	
	...
	function __construct(){		
		...
		require_once "{$dir}/goibibo/Goibibo_base.php";
		require_once "{$dir}/goibibo/Goibibo_hotel.php";
		require_once "{$dir}/goibibo/Goibibo_booking.php";
		require_once "{$dir}/goibibo/Goibibo_offers.php";
		}
